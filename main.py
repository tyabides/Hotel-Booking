...
df_cards = pd.read_csv("cards.csv", dtype=str).to_dict(orient="records") # loads csv as dictionary
...
class SecureCreditCard(CreditCard):
    # This SecureCreditCard class INHERITS the class CreditCard and all it's methods
